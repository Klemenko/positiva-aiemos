...
```sh
grep -rl 'positiva' ./ | xargs sed -i '' 's/positiva/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with positiva
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/positiva.git
    cd positiva
    ```
...
- [positiva integration Documentation](https://docs.vuestorefront.io/positiva)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `positiva` channel on [our Discord](discord.vuestorefront.io).
